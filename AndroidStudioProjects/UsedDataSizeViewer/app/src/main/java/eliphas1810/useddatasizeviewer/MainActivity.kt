...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateUsedDataSize() {
        try {
            ...
            findViewById<TextView>(R.id.todayMobileUsedDataSize)?.text = simpleDateFormat.format(todayCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(todayMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.oneDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(oneDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(oneDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.twoDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(twoDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(twoDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.threeDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(threeDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(threeDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.fourDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(fourDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(fourDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.fiveDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(fiveDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(fiveDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.sixDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(sixDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(sixDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.sevenDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(sevenDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(sevenDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.eightDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(eightDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(eightDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.nineDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(nineDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(nineDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.tenDayBeforeMobileUsedDataSize)?.text = simpleDateFormat.format(tenDayBeforeCalendar.time) + "  " + getString(R.string.mobile) + "  " + decimalFormat.format(tenDayBeforeMobileBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            ...
            findViewById<TextView>(R.id.todayWifiUsedDataSize)?.text = simpleDateFormat.format(todayCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(todayWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.oneDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(oneDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(oneDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.twoDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(twoDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(twoDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.threeDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(threeDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(threeDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.fourDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(fourDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(fourDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.fiveDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(fiveDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(fiveDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.sixDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(sixDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(sixDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.sevenDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(sevenDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(sevenDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.eightDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(eightDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(eightDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.nineDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(nineDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(nineDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
            findViewById<TextView>(R.id.tenDayBeforeWifiUsedDataSize)?.text = simpleDateFormat.format(tenDayBeforeCalendar.time) + "  " + getString(R.string.wifi) + "  " + decimalFormat.format(tenDayBeforeWifiBytes / 1024.0 / 1024.0 / 1024.0) + getString(R.string.giga_bytes)
